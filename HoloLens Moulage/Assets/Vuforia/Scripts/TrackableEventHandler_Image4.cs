...
/// </summary>
public class TrackableEventHandler_Image4 : MonoBehaviour, ITrackableEventHandler
{
    ...
    protected virtual void OnTrackingFound()
    {
        ...
        menu.transform.Find("ImageOption").transform.Find("Image4").transform.Find("Image4Check").gameObject.SetActive(true);
