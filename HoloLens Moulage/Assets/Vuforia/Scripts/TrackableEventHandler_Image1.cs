...
/// </summary>
public class TrackableEventHandler_Image1 : MonoBehaviour, ITrackableEventHandler
{
    ...
    protected virtual void OnTrackingFound()
    {
        ...
        menu.transform.Find("ImageOption").transform.Find("Image1").transform.Find("Image1Check").gameObject.SetActive(true);
